      ...
      <div className="about-modal">
        ...
        <div className="about-modal__content">
          ...
          <div className="about-modal__description">
            <p>Elmentra  helps developers convert their HTML, CSS, and JavaScript into Elementor's JSON structure, making it easier to migrate existing websites to Elementor.</p>
          </div>
        </div>
      </div>
    </div>
